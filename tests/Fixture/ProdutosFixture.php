...
class ProdutosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'slug' => ['type' => 'string', 'length' => 191, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_bin', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-04-22 16:42:47',
                'modified' => '2019-04-22 16:42:47'
            ],
        ];
        parent::init();
    }
